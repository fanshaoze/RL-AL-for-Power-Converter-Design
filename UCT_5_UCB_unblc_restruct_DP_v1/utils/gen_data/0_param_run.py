...
parser.add_argument('-n_comp', type=int, default=4, help='specify the number of component')
parser.add_argument('-n_topo', type=int, default=5,
                        help='specify the number of topology you want to generate')

args = parser.parse_args()

n_components=str(args.n_comp)
n_topology=str(args.n_topo)
...
if my_system == "windows":
    ...
    cmd_topology = "python3" + " 1_build_topology.py" + " -output_folder=" \
    + output_folder + " -ngspice_para=" + "\"" + ngspice_para + "\""+ " -cap_paras="  +cap_paras \
    + " -ind_paras=" + ind_paras + " -os=" + my_system +" -n_components=" + n_components \
    + "-n_topology=" + n_topology
