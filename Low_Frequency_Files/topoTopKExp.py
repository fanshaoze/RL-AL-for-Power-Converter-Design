...
from topoUtils import isomorphize_state_list
...
def gp_reward_uct_exp(args):
    ...
    if args.model == 'simulator' or args.model == 'analytics':
        ...
        factory = TransformerRewardSimFactory(
            eff_model_file=os.path.join(dir, 'transformer_SVGP/save_model/5_comp_eff_' + postfix + str(args.eff_model_seed) + '.pt'),
            vout_model_file=os.path.join(dir, 'transformer_SVGP/save_model/5_comp_vout_' + postfix + str(args.vout_model_seed) + '.pt'),
