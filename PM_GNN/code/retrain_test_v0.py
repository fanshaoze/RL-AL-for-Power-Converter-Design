...
# ======================== Arguments ==========================#
    ...
    parser.add_argument('-train_rate', type=float, default=0.01, help='# components')
...
# ======================== Data & Model ==========================#
    ...
    train_loader, val_loader, test_loader = split_balance_data(dataset5, batch_size,train_rate,0.1,0.1)
