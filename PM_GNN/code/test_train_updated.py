...
from ml_utils_updated import train, test, rse, initialize_model
import argparse
...
if __name__ == '__main__':
    ...
    parser.add_argument('-retrain', type=int, default=0, help='force retrain model')
    #    parser.add_argument('-seed', type=int, default=0, help='random seed')
    parser.add_argument('-seedrange', type=int, default=5, help='random seed')
    # ----------------------------------------------------------------------------------------------------#
